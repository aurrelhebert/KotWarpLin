...
class WarpScript(name: String) : Tag(name) {
    ...
    fun bucketize(entry: Element.() -> Unit, bucketizer: String, lastBucket: Long = 0L, bucketspan: Long = 0L, bucketcount: Long = 0L, init: ListTag.() -> Unit = {}): Bucketize {
    ...
    fun bucketize(load: Element, bucketizer: String, lastBucket: Long = 0L, bucketspan: Long = 0L, bucketcount: Long = 0L, init: ListTag.() -> Unit = {}): ListTag {
