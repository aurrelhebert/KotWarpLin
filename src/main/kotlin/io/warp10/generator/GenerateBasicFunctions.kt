...
fun main(args: Array<String>) {
    ...
    for (jsonFile in jsonFiles) {
        ...
        val basicFunctions: HashMap<String, ParameterFunction> = JSONParse.parseResourceFile(jsonFile, category)
        ...
        val file = File("src/main/kotlin/io/warp10/warpscriptDSL/${category.toString()}.kt")
        file.writeText(standaloneData.removeSuffix("\n").toString())
    }
}
